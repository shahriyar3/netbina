...
return [
    ...
    */
    ...
    'uuid'                 => 'مقدار :attribute باید حتما از نوع UUID باشد',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'tags'                  => 'کلمات کلیدی',
        'image2'                => 'عکس دوم',
        'page_description'      => 'متا تگ توضیحات',
        'current'               => 'رمز عبور فعلی',
        'user_type'             => 'نوع همکاری',
        'rules'                 => 'موافقتنامه قوانین',
        'key'                   => 'کلید',
        'value'                 => 'مقدار',
        'label'                 => 'برچسب',
        'type'                  => 'نوع',
        ...
        'post_id'               => 'پست',
        'policy'                => 'قوانین',
        'remember_token'        => 'کلید بازیابی رمز عبور',
        'isAdministrator'       => 'ادمین',
        'isBan'                 => 'ممنوع',
        'sub_title'             => 'زیر عنوان',
        'slug'                  => 'اسلاگ',
        'body'                  => 'متن',
